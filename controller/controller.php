...
class controller{
    ...
    private function incluir(){
        ...
        if($result >= 1){
            echo "<script>alert('Registro incluído com sucesso!');document.location='../login.php'</script>";
        }else{
    ...
    public function pesquisar($pesquisa, $var){
        $result = $this->cadastro->pesquisa($pesquisa, $var);
        if($result >= 1){
            return $result;
        }else{
    ...
    public function carrinho($id_cliente, $id_produto, $qttd){
        $result = $this->cadastro->carrinho($id_cliente, $id_produto, $qttd);
        if($result >= 1){
            return $result;
        }else{
    ...
    private function editar($id){
        ...
        if($result >= 1){
            echo "<script>alert('Registro alterado com sucesso!');document.location='../editarinfo.php?id=" . $id . "'</script>";
        }else{
