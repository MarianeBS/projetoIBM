        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="faleconosco.php<?php echo $url_id; ?>">Fale conosco</a></li>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
                        ...
                        <form method="post" action="controller/controller.php?funcao=contato" id="formLogin" name="formLogin">
                            ...
                            <div class="form-group mt-3">
                                <textarea class="form-control" name="txtMensagem" id="txtMensagem" rows="5" placeholder="Mensagem"
                                    required></textarea>
                            </div>
        ...
        <section id="faq" class="faq">
            <div class="container">
                ...
                <ul class="faq-list">
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">"Quais as formas de pagamento que a loja utiliza?"<i class="bi bi-chevron-down icon-show"></i><i
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq2">"Como funciona o valor de frete dos produtos?"<i class="bi bi-chevron-down icon-show"></i><i
                                class="bi bi-chevron-up icon-close"></i></div>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq3">"O produto que comprei veio com defeito, o que devo fazer para trocá-lo?"<i class="bi bi-chevron-down icon-"></i><i
                                class="bi bi-chevron-up icon-close"></i></div>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq4">"Não gostei do produto que comprei. Posso trocar por outro brinquedo ou pedir meu dinheiro de volta?"<i class="bi bi-chevron-down icon-show"></i><i
                                class="bi bi-chevron-up icon-close"></i></div>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq5">"Posso comprar produtos pelo site e retirar em uma loja física?"<i class="bi bi-chevron-down icon-show"></i><i
                                class="bi bi-chevron-up icon-close"></i></div>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq6">"Qual o prazo de entrega mínimo e máximo da loja?"<i class="bi bi-chevron-down icon-show"></i><i
                                class="bi bi-chevron-up icon-close"></i></div>
