                ...
                <form method="post" action="controller/controller.php?funcao=login" id="formLogin" name="formLogin">
                  <div class="row">
                    ...
                    <div class="form-group mt-3">
                      <input type="email" class="form-control" name="txtLogin" id="txtLogin" placeholder="Seu e-mail"
                        required>
                    </div>
                  </div>
                  <div class="form-group mt-3">
                    ...
                    <input type="password" minlength="6" maxlength="14" placeholder="Sua senha" class="form-control"
                      name="txtPass" required id="txtPass">
                  </div>
