    ...
    <body>
      ...
      <header id="header" class="d-flex">
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <div class="logo">
            <h1><img src="img/MagicHat/logo.png" style="max-width: 50px;">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto" href="<?php echo $url; ?>">
                  <ion-icon id="person" style="width: 50px; height: 27px;" name="person"></ion-icon>
                </a>
            </ul>
        ...
        <section id="hero" class="d-flex flex-column justify-content-end align-items-center">
          <div id="heroCarousel" class=" container-fluid  carousel carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <img src="img/MagicHat/CortinaNav-v4.png" class="ratio imgteste">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-6">
                  <div class="icon-box" data-aos="zoom-in-left">
                    ...
                    <h4 class="title"><a href="produtos.php?bonecas<?php echo $url_id; ?>">Bonecas</a></h4>
                  </div>
                </div>

                <div class="col-lg-4 col-md-6 mt-5 mt-lg-0 ">
                  <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="200">
                    <div class="icon"><img src="img/categorias/bonecos.png" style="height: 100px; width: 100px; ">
                    </div>
                    <h4 class="title"><a href="produtos.php?bonecos<?php echo $url_id; ?>">Bonecos</a></h4>
                ...
                <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
                  <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="100">
                    ...
                    <h4 class="title"><a href="produtos.php?carrinhos<?php echo $url_id; ?>">Carrinhos</a></h4>
                ...
                <div class="col-lg-4 col-md-6 mt-5">
                  <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="300">
                    ...
                    <h4 class="title"><a href="produtos.php?herois<?php echo $url_id; ?>">Heróis</a></h4>
                ...
                <div class="col-lg-4 col-md-6 mt-5">
                  <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="400">
                    ...
                    <h4 class="title"><a href="produtos.php?jogos<?php echo $url_id; ?>">Jogos</a></h4>
                ...
                <div class="col-lg-4 col-md-6 mt-5">
                  <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="500">
                    ...
                    <h4 class="title"><a href="produtos.php?princesas<?php echo $url_id; ?>">Princesas</a></h4>
